...
class AutoGenerator {
    ...
    generateText() {
        ...
        tableNames.forEach(table => {
            ...
            if (this.options.lang === 'ts') {
                ...
                str += this.addTypeScriptFields(table, true, tableTypeOverride, typeOverrides === null || typeOverrides === void 0 ? void 0 : typeOverrides.useOptionalForNullColumns) + "}\n\n";
                ...
                str += this.addTypeScriptFields(table, false, tableTypeOverride, typeOverrides === null || typeOverrides === void 0 ? void 0 : typeOverrides.useOptionalForNullColumns);
                str += "\n" + associations.str;
    ...
    addTypeScriptFields(table, isInterface, tableTypeOverride, useOptionalForNullColumns) {
        const sp = this.space[1];
        const fields = lodash_1.default.keys(this.tables[table]);
        let str = '';
